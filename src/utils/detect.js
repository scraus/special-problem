...
const preprocess = (source, modelWidth, modelHeight) => {
  ...
  const input = tf.tidy(() => {
    ...
    // console.log(img.shape.slice(0, 2))
...
export const detect = async (source, model, canvasRef, callback = () => {}) => {
  // console.log(model.inputShape, model.inputShape.slice(1, 3))
  ...
  const [scores, classes] = tf.tidy(() => {
    ...
    // console.log(rawScores.max(1), rawScores.argMax(1))
  ...
  //   console.log('maxScores shape:', maxScores.shape);
  //   const classIndices = rawScores.argMax(1);
  //   console.log('classIndices shape:', classIndices.shape);
  //   return [maxScores, classIndices];
  // });
